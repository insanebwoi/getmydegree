...
const featured = courses.filter((c) =>
  ["BBA", "BCA", "MBA", "MCA"].includes(c.code),
);
    ...
    <>
      ...
      <section className="shell pt-2 pb-16 lg:pb-24">
        <div className="panel relative overflow-hidden px-5 pt-14 pb-8 sm:px-8 lg:pt-20 lg:px-10 lg:pb-10">
          ...
          />
          <span
            className="chip absolute top-10 left-6 hidden lg:grid"
            aria-hidden="true"
          >
            <GraduationCap size={19} />
          </span>
          <span
            className="chip absolute top-10 right-6 hidden lg:grid"
            aria-hidden="true"
          >
            <BadgeCheck size={19} />
          </span>
              ...
              <Reveal key={p.situation} delay={i * 70}>
                <div className="card card-hover p-5 lg:p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="badge ml-auto hidden shrink-0 sm:inline-flex">
                      {p.answer}
                    </span>
                  </div>
                </div>
      ...
      <Section
        ...
        title="From first call to enrolment in 48 hours"
      >
      ...
      <Section
        badge="International"
        title="Triple certification MBA, awarded in the UK"
      >
        <div className="grid gap-4 lg:grid-cols-12">
          <Reveal className="lg:col-span-7">
