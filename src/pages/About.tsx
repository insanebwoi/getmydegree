          ...
          <Reveal delay={100} className="lg:col-span-6">
            <div className="card card-p h-full sm:p-7 lg:p-9">
              <p className="t-body text-muted">
                Someone left in the second year of a B.Com for a job abroad.
                Someone finished twelfth and never got the chance. Someone has
                managed a team for eight years and cannot be promoted without a
                piece of paper.
              </p>
              <p className="t-body mt-4 text-muted">
                We map what you already completed against what a recognized
                university will accept, then run the admission, the
                documentation and the follow-through until the degree is in your
                hand.
              </p>
